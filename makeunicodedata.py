...
def makeunicodetype(unicode, trace):
    ...
    print("static const _PyUnicode_TypeRecord _PyUnicode_TypeRecords[] = {", file=fp)
    for item in table:
        print("    {%d, %d, %d, %d, %d, %d}," % item, file=fp)
    print("};", file=fp)
    print(file=fp)
    ...
    print(file=fp)
    print("static const Py_UCS4 _PyUnicode_ExtendedCase[] = {", file=fp)
...
def makeunicodeprop(unicode, trace):
    ...
    print(file=fp)
    print('#define UNIDATA_VERSION "%s"' % UNIDATA_VERSION, file=fp)
    print("/* a list of unique unicode property sets */", file=fp)
    print("static const _PyUnicode_PropertySet _PyUnicode_Property_Sets[] = {", file=fp)
    for item in table:
    ...
    print("/* index tables for the database records */", file=fp)
    print("#define PROP_SHIFT", shift, file=fp)
...
def makeunicodeunihan(unicode, trace):
    ...
    print(file=fp)
    print('#define UNIDATA_VERSION "%s"' % UNIDATA_VERSION, file=fp)
    print("/* a list of unique Unihan property sets */", file=fp)
    print("static const _PyUnicode_UnihanSet _PyUnicode_Unihan_Sets[] = {", file=fp)
    for item in table:
        print("    {%d}," % item, file=fp)
    print("};", file=fp)
    print(file=fp)
    ...
    print("/* index tables for the database records */", file=fp)
    print("#define UNIHAN_SHIFT", shift, file=fp)
